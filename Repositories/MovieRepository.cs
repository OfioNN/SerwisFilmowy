                    ...
                    using (FbConnection connection = new FbConnection(connectionString)) {
                        try {
                            ...
                            if (connection.State == ConnectionState.Open) {
                                ...
                                string dbQuery = "CREATE TABLE Movies (ID INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, TITLE CHARACTER VARYING(100), DIRECTOR CHARACTER VARYING(50), STAFF CHARACTER VARYING(200), DESCRIPTION CHARACTER VARYING(2000), IMAGE BLOB);";
